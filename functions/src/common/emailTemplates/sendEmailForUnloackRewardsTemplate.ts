...
export const sendEmailForUnloackRewardsTemplate = (userName: any, appLink: any) => {
   return `<!DOCTYPE html
...
<head>
   <title> Earn Rewards by Voting and Minting Your PAX Tokens on Coin Parliament</title>
                        ...
                        <tr>
                           <td align="center" valign="bottom" style="padding: 10px 0px 0px 0px;">
                              <a href="#" target="_blank"
                                 ...
                                 <img src="https://firebasestorage.googleapis.com/v0/b/coin-parliament-staging.appspot.com/o/assests%2Femails%2Fspace-collection.png?alt=media&token=1d11c300-bb8b-4f38-9a0a-a36b94c45755" alt="Coin Parliament Vote To Earn" class="inx_img"
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">Earn Rewards by Voting and Minting Your PAX Tokens on Coin Parliament
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Did you know that every vote you cast on Coin Parliament contributes to the mining of PAX
                              tokens? Start voting today and mint your own PAX tokens while earning valuable rewards.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Each vote brings you one step closer to unlocking exciting rewards and contributing to the
                              vibrant Coin Parliament community.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Don't miss out on this opportunity – start voting and minting your PAX tokens today!
                           </td>
                        </tr>
