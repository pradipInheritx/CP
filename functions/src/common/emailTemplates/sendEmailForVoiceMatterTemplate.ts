...
<head>
   <title>Your Voice Matters! Cast Your Votes Today On Coin Parliament</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">Your Voice Matters! Cast Your Votes Today On Coin Parliament</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Your vote is your voice! Don't miss out on the opportunity to shape the future of
                              cryptocurrency by voting on Coin Parliament.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Each vote you cast not only influences community sentiment but also <strong>earns you
                                 valuable rewards and contributes to the mining of PAX tokens</strong>.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Head over to Coin Parliament now and make your voice heard!
                           </td>
                        </tr>
