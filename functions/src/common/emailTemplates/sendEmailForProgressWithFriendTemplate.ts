...
export const sendEmailForProgressWithFriendTemplate = (userName: any, appLink: any) => {
   return `<!DOCTYPE html
...
<head>
   <title>Accelerate Your Coin Mining Progress With Your Friends' Support!</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">Accelerate Your Coin Mining Progress With Your Friends' Support!</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Did you know that your friends can help you speed up your Coin Mining Progress (CMP) on
                              Coin Parliament? By referring them to join the platform and upgrade their accounts, you'll
                              not only earn rewards but also accelerate your CMP process.
                           </td>
                        </tr>
                              ...
                              <table width="150" align="center" border="0" cellspacing="0" cellpadding="0"
                                 ...
                                 <tr>
                                    <td height="38" valign="middle" class="red"
                                       ...
                                       <a href="${appLink}/profile/mine" target="_blank"
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Invite your friends today and start earning together while enjoying the benefits of Coin
                              Parliament!
                           </td>
                        </tr>
