...
export const sendEmailForSVIUpdateTemplate = (userName: any, appLink: any) => {
   return `<!DOCTYPE html
...
<head>
   <title>Stay Informed With Bitcoin SVI Updates On Coin Parliament</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">Stay Informed With Bitcoin SVI Updates On Coin Parliament</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Stay ahead of the curve with the latest Bitcoin SVI (Social Voting Indicator) updates on
                              Coin Parliament! Gain valuable insights into community sentiment, trends, and voting
                        ...
                        <tr>
                           <td align="center" valign="bottom" style="padding: 0px 0px 30px 0px;">
                              <a href="#" target="_blank"
                                 style="color:#000;text-decoration:none; display:inline-block;">
                                 <img src="https://firebasestorage.googleapis.com/v0/b/coin-parliament-staging.appspot.com/o/assests%2Femails%2Fsvi-slide.png?alt=media&token=6a106a2e-7ca9-4fc9-95c9-adfa62d9a216" alt="Coin Parliament Vote To Earn" class="inx_img"
                                    width="300" height="104" border="0"
                                    style="display:block;font-family: 'Poppins', Arial, sans-serif;color:#ffffff;font-weight:bold;font-size:24px;max-width:300px;" />
                              </a>
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Don't miss out on this valuable resource – stay informed and engaged with Bitcoin SVI
                              updates on Coin Parliament.
                           </td>
                        </tr>
