...
export const sendEmailForAddressNotUpdatedTemplate = (userName: any, appLink: any) => {
    return `<!DOCTYPE html
...
<head>
   <title>Update Your Wallet Address For Seamless Rewards On Coin Parliament</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title"><span style="color: #49bf49;">Important:</span> Update Your Wallet
                              Address For Seamless Rewards On Coin Parliament</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Your rewards are waiting for you! To ensure you receive your hard-earned earnings
                              seamlessly, don't forget to fill up your wallet address on Coin Parliament.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Updating your wallet address is quick and easy – simply log in to your account and
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Don't leave your rewards behind – update your wallet address now!
                           </td>
                        </tr>
                              ...
                              <table width="150" align="center" border="0" cellspacing="0" cellpadding="0"
                                 ...
                                 <tr>
                                    <td height="38" valign="middle" class="red"
                                       ...
                                       <a href="${appLink}/profile/wallet" target="_blank"
                                          style="text-decoration:none;color: #ffffff;display: block;line-height: 38px;">Update
                                          Now!</a>
                                    </td>
                                 </tr>
                              </table>
