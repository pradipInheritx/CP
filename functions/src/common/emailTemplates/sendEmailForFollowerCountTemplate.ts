...
export const sendEmailForFollowerCountTemplate = (userName: any, totalFollowerCount: any, appLink: any) => {
    return `<!DOCTYPE html
...
<head>
   <title>New Followers Alert!</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">New Followers Alert!</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Guess what? You're gaining traction in Coin Parliament! This week, your profile
                              attracted ${totalFollowerCount} new followers!
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Your influence is spreading, and your content is resonating with more and more people.
                              Keep shining bright!
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Stay tuned for more updates and keep rocking the Coin Parliament community!
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Cheers,<br />
                              <span style="font-weight: 600;">Coin Parliament Community Manager</span>
                           </td>
                        </tr>
                     </table>
                  </td>
