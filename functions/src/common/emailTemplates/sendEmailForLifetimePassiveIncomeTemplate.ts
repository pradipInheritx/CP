...
<head>
   <title>Your Social Media Can Make You Lifetime Passive Income!</title>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                           <td valign="top"
                              ...
                              class="inx_title">Your Social Media Can Make You Lifetime Passive Income!</td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              ...
                              Hope you're doing well! We've got some exciting news to share with you – ever thought
                              about becoming a Coin Parliament Ambassador?
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Our Ambassador Program is all about rewarding awesome members like you for sharing the
                              love and helping us grow our community. And the best part? You can start earning from day
                              one, directly into your wallet!
                           </td>
                        </tr>

                        <tr>
                           <td align="center" valign="bottom" style="padding: 0px 0px 30px 0px;">
                              <a href="#" target="_blank"
                                 style="color:#000;text-decoration:none; display:inline-block;">
                                 <img src="https://firebasestorage.googleapis.com/v0/b/coin-parliament-staging.appspot.com/o/assests%2Femails%2Fambsdr-mens.png?alt=media&token=293ab946-70f5-4ec6-9ad4-99a03fa62bf6" alt="Coin Parliament Vote To Earn" class="inx_img"
                                    width="200" height="159" border="0"
                              ...
                              <table width="150" align="center" border="0" cellspacing="0" cellpadding="0"
                                 ...
                                 <tr>
                                    <td height="38" valign="middle" class="red"
                                       ...
                                       <a href="https://coinparliament.com/Ambassador" target="_blank"
                                          style="text-decoration:none;color: #ffffff;display: block;line-height: 38px;">Start
                                          Earning</a>
                                    </td>
                                 </tr>
                              </table>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:20px;line-height: 24px;text-align: left;font-weight:700;padding-bottom: 15px;">
                              Here's how it works:
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Invite Your Friends: Share your unique referral link on any social media platform and
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Start Earning: For every friend you invite who signs up and makes a purchase, you'll start
                              earning rewards instantly, directly into your wallet! Plus, you'll continue to earn a
                              lifetime passive income of 50% from all your friends' purchases.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              It's that simple! By joining our Ambassador Program, you'll not only be earning rewards
                              for yourself but also becoming an integral part of our community's growth and success.
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Ready to start earning from day one and become a Coin Parliament Ambassador? Click [here]
                              to sign up now and let the rewards begin!
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              If you have any questions or need assistance, feel free to reach out to us. We're here to
                              help!
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td valign="top"
                              style="color: #333333;font-family: 'Poppins', Arial, sans-serif;font-size:14px;line-height: 24px;text-align: left;font-weight:400;padding-bottom: 15px;">
                              Thanks for being an awesome member of Coin Parliament – we can't wait to see you thrive as
                              an Ambassador!
                           </td>
                        </tr>
