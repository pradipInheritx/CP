  ...
  return (
    <React.Fragment>
      <TableRow className={clsx(classes.tableRowRoot, open ? "active" : "")}>
        <TableCell
          className={clsx(classes.tableCellRoot, classes.tableCellFirst)}
        >
          <CmtObjectSummary
        ...
        <TableCell
          className={clsx(classes.tableCellRoot, classes.tableCellSecond)}
        >
          {timeFromNow(row.lastPaymentDate)}
        </TableCell>
        <TableCell
          className={clsx(classes.tableCellRoot, classes.tableCellHideShow)}
      ...
      <TableRow
        className={clsx(
          ...
          open ? "active" : "collapse-table-row"
        )}
      >
