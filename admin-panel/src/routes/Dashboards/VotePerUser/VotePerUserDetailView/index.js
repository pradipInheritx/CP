          ...
          {/* <Box ml={1}>
            <Tooltip title={"status"}>
              <IconButton aria-label="filter list">
                {currentVotePerUser?.chosen === false && <Block color="primary" />}
                {currentVotePerUser?.chosen === true && <CheckCircleOutline color="primary" />}
              </IconButton>
            </Tooltip>
          </Box> */}
          <Box ml={1}>
...
export default VotePerUserDetailView;

VotePerUserDetailView.prototype = {
