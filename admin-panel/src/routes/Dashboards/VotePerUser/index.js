...
const VotePerUserModule = () => {
  ...
  const { votePerUserList , totalCount} = useSelector(({ VotePerUser }) => VotePerUser);
  ...
  useEffect(
    () => {
      dispatch(
        getVotePerUser(filterOptions, debouncedSearchTerm,page ,rowsPerPage ,orderBy ,order , () => {
  ...
  console.log(votePerUserList,"votePerUserList")
...
const handleConfirmUpdate = () => {
  ...
  dispatch(updateVotePerUserStatus(selectedUser?.timeframeId, {
    ...selectedUser,
