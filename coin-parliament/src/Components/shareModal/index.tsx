...
const I = styled.i`
  ...
  color:#6352e9;
`;
const ShareModal: React.FC<{ shareModalShow: boolean, setShareModalShow: React.Dispatch<React.SetStateAction<boolean>>, url: string, shareText: string, closeAction?: () => void, addPaxWalletPop?: any, setAddPaxWalletPop?: any }> = ({ shareModalShow, setShareModalShow, url, shareText, closeAction, addPaxWalletPop, setAddPaxWalletPop }) => {
