export const texts = {
  ...
  FoundationSelect: 'For every vote you cast, Sport Parliament will match it and donate to one of The following foundations',
  ...
  Bear:"bear",
  Bull: "bull",
  InstallCoinParliament: "Install Sport Parliament app for best experience".toUpperCase(),
  ...
  CoinParliamentBalance: "Sport Parliament Balance".toUpperCase(),
  ...
  AboutCoinParliament: "About Sport Parliament".toUpperCase(),
  GAMERULECOINPARLIAMENT: "GAME RULE SPORT PARLIAMENT".toUpperCase(),
