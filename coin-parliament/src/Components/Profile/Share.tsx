  ...
  return (
    ...
    >
      ...
      <PoolBox style={{ paddingTop: '5em' }}>
        ...
        {window.screen.width > 767 && <p className={`${classes.footerAmb2} text-center`}>Your friends will be an integral part of your progress and income <span className={classes.foreverText}>FOREVER!</span></p>}
        {window.screen.width > 767 && <p className={`${classes.footerAmb2} text-center`}>SHARE NOW TO START EARNING!</p>}
