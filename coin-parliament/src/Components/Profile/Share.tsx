  ...
  return (
    <PoolBox>
      ...
      <div className="d-flex justify-content-center text-center">
        <span className={classes.shareSubHeaderText} style={{ color: '#684dc9', background: "linear-gradient(180deg, #FEFEFE 35.94%, #3C1ABA 100%)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Stoct Parliament</span>
      </div>
      <div className="d-flex justify-content-center text-center">
