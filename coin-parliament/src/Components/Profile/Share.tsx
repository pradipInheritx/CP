              ...
              <div className={classes.description} style={{ fontSize: '1.2em' }}>
                <ul>
                  <div className="d-flex ">
                    <div>                      
                      <li className={`${classes.textsomechange}`} >Invite your friends to become Stock Parliament members and enjoy the benefits of being our partner.
