...
const GoogleAuthenticator = () => {
  ...
  const verifyOtp = async (token:string) => {
    try {
      ...
      showToast(
        "2FA enabled successfully.",ToastType.SUCCESS
      );
    } catch (error:any) {
      showToast(
  ...
  return (<>
    ...
    >
      ...
      <Row>
      <Col  className="mt-2">
        <Label>Two-factor authentication is already enabled for your account. You will need to enter the 6-digit code generated by your authenticator app every time you log in to your account.


        </Label><Label>
        To disable 2FA or switch to a different authentication method, please go to your account settings. We strongly recommend keeping 2FA enabled to enhance the security of your account.</Label>
...
If you have not set up 2FA, please do so now to enhance the security of your account. You can use any TOTP-based authenticator app, such as Google Authenticator or Authy, to generate codes.</Label>
                ...
                <Col>
                  <Container className="p-0">
                    <Row className="m-0" style={{justifyContent:'center'}}>
                      ...
                      <img src={qrCodeDataUrl} alt="QR code for Google Authenticator" style={{maxWidth:'300px'}}/>
                    ...
                    />  <Buttons.Error onClick={(e) => {navigator.clipboard.writeText(secretKey)
                    setCopied(true)}}>{!copied?'COPY':'COPIED'}</Buttons.Error>
      ...
      <button onClick={(e) => navigator.clipboard.writeText(secretKey)}>Copy</button> */}
                    ...
                    />  <Buttons.Primary onClick={(e) => verifyOtp(textData)}>Enable</Buttons.Primary>
                    {/* <input type="text" value={secretKey} />
      <button onClick={(e) => navigator.clipboard.writeText(secretKey)}>Copy</button> */}
      </div>
                    {/* <input type="text"  />
