...
<div className="progress">
            ...
            <div className="right"></div>
											...
											</HeaderCenter>
											{
												...
												<div
													className=''
													style={{ width: "50%", marginLeft: "140px", marginTop: "5px", textAlign: "left", fontWeight: "100px", }}												
												>
...
<div className="d-flex align-items-center shaped-btn-row">
	<button className="btn-shaped me-1">COIN</button>
	<button className="btn-shaped left-side">PAIR</button>
</div>
