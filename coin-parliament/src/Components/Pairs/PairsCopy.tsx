      ...
      <MidDiv >
        ...
        borderRadius:"10px"
          ...
          >
           ...
           <ImgName>
            <img src={items.img1} alt=""  width={"86px"} height={"75px"} style={{border:"1px solid #868686",borderRadius:"50%"}}/>
           ...
           <ImgName>
             <img src={items.img2} alt="" width={"86px"} height={"75px"} style={{border:"1px solid #868686",borderRadius:"50%"}}/>
