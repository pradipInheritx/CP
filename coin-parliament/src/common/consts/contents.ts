...
export const FrequentlyAskQus = [
  ...
  {
    question: 'How does the Partners Program work?',
    answer: "The Partners Program allows you to refer friends to the platform. You earn 50% lifetime commissions from the purchase amounts made by the members you've referred. Simply share your referral link, and commissions are sent directly to your wallet.",
  },
  {
