...
const About = () => {
  return (
    <GeneralPage>
      <div >
        <h1>About Voting Parliament</h1>
        <p>Voting Parliament Voting Parliament aims to provide a community environment where all of our users can share their
        ...
        <p>Whoever fails to follow our rules will have their messages deleted, and further action taken if necessary. Coin
          ...
          any messages from the Voting Parliament discussion feature if community rules are repeatedly violated.</p>
      </div>
    </GeneralPage>
  );
};
