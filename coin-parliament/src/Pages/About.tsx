  ...
  return (
    <GeneralPage>
      ...
      <img src={shark} alt="" width={window.screen.width>767? "300px":"250px" }/>
        ...
        {!user?.uid  && window.screen.width > 979 && <div className='d-sx-none'> <Buttons.Primary style={{margin:'auto', marginTop:'4rem', fontSize:'2rem', padding:'2rem'}} onClick={e=>{  setLogin(true)
        setSignup(true)}}>{texts.signUp}</Buttons.Primary></div>}
